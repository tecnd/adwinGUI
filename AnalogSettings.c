...
/**
Change information in the AnalogChannel Properties based on the text and number
boxes.
*/
...
/**
Changes the displayed information as we change the analog line that we look
at through the ring control.
*/
